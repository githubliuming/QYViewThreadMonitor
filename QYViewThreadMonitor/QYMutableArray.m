...
- (dispatch_queue_t)syncQueue {
    ...
    dispatch_once(&onceToken, ^{
        queue = dispatch_queue_create("com.qy.ItemBarrierAsyncSetter", DISPATCH_QUEUE_CONCURRENT);
    });
...
- (void)runAsnc:(void(^)(void))block{

    dispatch_barrier_async(self.syncQueue, block);
}
@end
