...
+ (void) load
{
    ...
    dispatch_once(&onceToken, ^{
           ...
           [QYSwizzleHelper swizzleMethods:[self class] originalSelector:@selector(setNeedsDisplayInRect:) swizzledSelector:@selector(qy_setNeedsDisplayInRect:)];
        [QYSwizzleHelper swizzleMethods:[self class] originalSelector:@selector(drawInContext:) swizzledSelector:@selector(qy_drawInContext:)];
        [QYSwizzleHelper swizzleMethods:[self class] originalSelector:@selector(layoutSublayers) swizzledSelector:@selector(qy_layoutSublayers)];
    });
