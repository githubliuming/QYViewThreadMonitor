...
+ (void)load
{
    ...
    dispatch_once(&onceToken, ^{
        ...
        [QYSwizzleHelper swizzleMethods:[self class] originalSelector:@selector(setNeedsLayout) swizzledSelector:@selector(qy_setNeedsLayout)];
        [QYSwizzleHelper swizzleMethods:[self class] originalSelector:@selector(setNeedsDisplay) swizzledSelector:@selector(qy_setNeedsDisplay)];
    });
